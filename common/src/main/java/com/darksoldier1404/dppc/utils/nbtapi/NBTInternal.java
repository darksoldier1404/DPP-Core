...
import com.darksoldier1404.dppc.utils.nbtapi.iface.*;
...
import com.darksoldier1404.dppc.utils.nbtapi.wrapper.NBTProxy;
import com.darksoldier1404.dppc.utils.nbtapi.wrapper.ProxyBuilder;
...
public class NBTInternal {
    ...
    public static void modifyComponents(ItemStack item, Consumer<ReadWriteNBT> consumer) {
        ...
        ReadWriteNBT nbti = NBTInternal.itemStackToNBT(item);
        consumer.accept(nbti.getOrCreateCompound("components"));
        ItemStack tmp = NBTInternal.itemStackFromNBT(nbti);
